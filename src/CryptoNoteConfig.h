...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x23cbd0; // addresses start with "0xDB"
...
const uint64_t DEPOSIT_MIN_AMOUNT                            = 1000 * COIN;
const uint32_t DEPOSIT_MIN_TERM                              = 10000;  // approximately one week
const uint32_t DEPOSIT_MAX_TERM                              = 10 * 52 * 10000;
...
const uint64_t START_BLOCK_REWARD                            = (UINT64_C(40000) * parameters::COIN);
const uint64_t MIN_BLOCK_REWARD                              = (UINT64_C(75) * parameters::COIN);
...
const int      P2P_DEFAULT_PORT                              = 9636;
const int      RPC_DEFAULT_PORT                              = 9635;
